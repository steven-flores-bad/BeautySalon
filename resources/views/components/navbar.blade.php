<nav class="bg-gray-50 border-b border-gray-200 sticky top-0 z-40 shadow-sm" x-data="{ mobileMenuOpen: false, profileDropdown: false, reportsDropdown: false }">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-8">
                ...
                <div class="hidden md:flex items-center space-x-2">
                    ...
                    <!-- VENTAS CON VALIDACIÓN DINÁMICA -->
                    <a href="{{ route('sales.index') }}" class="px-3 py-2 rounded-lg text-sm font-semibold transition {{ request()->routeIs('sales.*') ? 'bg-white shadow-sm border border-gray-200 text-pink-600' : 'text-gray-700 hover:text-pink-600 hover:bg-pink-50' }}">
                        Ventas / Caja
                    </a>
                    ...
                    <div class="relative" @click.away="reportsDropdown = false">
                        ...
                        <div x-show="reportsDropdown" x-cloak class="absolute left-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50">
                            ...
                            <span class="flex items-center justify-between px-4 py-2 text-sm text-gray-400 cursor-not-allowed">
                                Reporte de Servicios
                                <span class="text-[10px] uppercase font-semibold bg-gray-100 text-gray-400 px-1.5 py-0.5 rounded">Próximamente</span>
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <div x-show="mobileMenuOpen" x-cloak class="md:hidden border-t border-gray-200 bg-white px-4 pt-2 pb-4 space-y-1">
        ...
        <a href="{{ route('sales.index') }}" class="block px-3 py-2 rounded-lg text-base font-semibold {{ request()->routeIs('sales.*') ? 'bg-gray-100 border border-gray-200 text-pink-600' : 'text-gray-700 hover:bg-pink-50 hover:text-pink-600' }}">Ventas / Caja</a>
        ...
        <!-- REPORTES MÓVIL (submenu simple, sin dropdown para simplificar el tap en pantallas táctiles) -->
        <div class="pt-1">
            ...
            <span class="flex items-center justify-between px-3 py-2 text-base text-gray-400">
                Reporte de Servicios
                <span class="text-[10px] uppercase font-semibold bg-gray-100 text-gray-400 px-1.5 py-0.5 rounded">Próximamente</span>
            </span>
        </div>
